...
#define WORD 258
#define SPECIAL 259
#define REERROR_OUT 260
#define REERROR_FILE 261
...
{
       0,    12,    12,    13,    17,    18,    21,    22,    23,    27,
      28,    29,    32,    33,    36,    39,    40,    43,    44,    48,
      53,    57,    61
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "SPECIAL", "REERROR_OUT",
  "REERROR_FILE", "'\\n'", "'<'", "'>'", "'&'", "'|'", "$accept",
  "program", "rein", "reout", "reerror", "backG", "arg", "listarg",
  "cmd_pipe", "cmd_pipe_rein", "cmd_pipe_rein_reout",
  "cmd_pipe_rein_reout_reerror", "cmd_pipe_rein_reout_reerror_back", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    10,    60,    62,
      38,   124
};
# endif
...
{
       3,     0,     1,    14,    16,    18,     5,     8,    11,    13,
       0,    15,     0,    19,    20,    21,    22,     2,    17,     0,
       0,     9,    10,    12,     4,     6,     0,     7
};
...
{
      11,    25,     2,     3,    12,     3,    17,    26,    21,    22,
      20,    24,    19,    11,    27,    23,     0,     0,    18
};

static const yytype_int8 yycheck[] =
{
       5,     3,     0,     3,    11,     3,     7,     9,     5,     6,
       9,     3,     8,    18,     3,    10,    -1,    -1,    12
};
...
{
       0,    13,     0,     3,    18,    19,    20,    21,    22,    23,
      24,    18,    11,    14,    15,    16,    17,     7,    19,     8,
       9,     5,     6,    10,     3,     3,     9,     3
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 12 "shell.y" /* yacc.c:1646  */
    {  countCmd++; YYACCEPT;}
#line 1224 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 17 "shell.y" /* yacc.c:1646  */
    { (yyval)=(yyvsp[0]); }
#line 1230 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 18 "shell.y" /* yacc.c:1646  */
    { (yyval) = -1; }
...
#line 39 "shell.y" /* yacc.c:1646  */
    { (yyval)=(yyvsp[-1]); cmds[(yyvsp[-1])].args[cmds[(yyvsp[-1])].numArg++]=(yyvsp[0]); }
#line 1296 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 40 "shell.y" /* yacc.c:1646  */
    { (yyval)=countCmd; cmds[(yyval)].args[cmds[(yyval)].numArg++]=(yyvsp[0]); countCmd++; }
#line 1302 "y.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 43 "shell.y" /* yacc.c:1646  */
    { }
